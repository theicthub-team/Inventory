     ...
     <div class="container-fluid">
       ...
       <div class="collapse navbar-collapse" id="sidenav-collapse-main">
         ...
         <ul class="navbar-nav">
           ...
           <a class=" nav-link active text-white " href=""> <i class="ni ni-tv-2 text-primary"></i> Dashboard
             </a>
           </li>
           <li class="nav-item">
         ...
         <hr class="my-3">
         <!-- Heading -->
         <h6 class="navbar-heading text-muted">Add-ons</h6>
         <!-- Navigation -->
         <ul class="navbar-nav mb-md-3">
           ...
           <li class="nav-item">
             <a class="nav-link text-white " href="">
               <i class="ni ni-ui-04"></i> Settings
             </a>
           </li>
         </ul>
       </div>
